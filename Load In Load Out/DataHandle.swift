...
class DataHandle {
    ...
    func mockDataFill() {
        ...
        let truck1 : Truck = Truck(title: "Truck 1", captain: "Caleb Lindsey", crates: [crate1, crate2, crate3], date: Date(), notes: "This is a big truck.", loaded: false)
        let truck2 : Truck = Truck(title: "Truck 2", captain: "Ellie Granata", crates: [crate1, crate5, crate4], date: Date(), notes: "This is my favorite truck.", loaded: false)
        let truck3 : Truck = Truck(title: "Truck 3", captain: "Danielle Florent", crates: [crate4, crate5, crate2], date: Date(), notes: "This is a small truck.", loaded: false)
